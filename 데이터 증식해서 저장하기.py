...
i = 0
for batch in augmentation.flow_from_directory('C:\\prj_Workspace\\imagesForTrain\\euro\\train\\Europe_5_euro',          # 원본 이미지
                                              batch_size=1, 
                                              save_to_dir='C:\\prj_Workspace\\imagesForTrain\\euro\\train\\Europe_5_euro',          # 변환 이미지
                                              save_prefix='Europe_5_euro',                 # 이미지명 앞 이름
...
i = 0
for batch in augmentation1.flow_from_directory('C:\\prj_Workspace\\imagesForTrain\\euro\\train\\Europe_5_euro',          # 원본 이미지
                                              batch_size=1,
                                              save_to_dir='C:\\prj_Workspace\\imagesForTrain\\euro\\train\\Europe_5_euro',          # 변환 이미지
                                              save_prefix='Europe_5_euro',                 # 이미지명 앞 이름
                                              save_format='jpg'):               # 이미지 포멧
...
augmentation2 = ImageDataGenerator(zoom_range = 0.4,                             # image 확대/축소(random)
                                  ...
                                  horizontal_flip=True,                         # 좌우 반전
                                  vertical_flip=True,                           # 상하 반전
                                  rotation_range=50                             # 랜덤 회전
                                  )
i = 0
for batch in augmentation2.flow_from_directory('C:\\prj_Workspace\\imagesForTrain\\euro\\train\\Europe_5_euro',          # 원본 이미지
                                              batch_size=1,
                                              save_to_dir='C:\\prj_Workspace\\imagesForTrain\\euro\\train\\Europe_5_euro',          # 변환 이미지
                                              save_prefix='Europe_5_euro',                 # 이미지명 앞 이름
                                              save_format='jpg'):               # 이미지 포멧
